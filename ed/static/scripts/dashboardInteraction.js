...
function addLogEntry() {
    ...
    container.innerHTML += `
    <div class="entry">
        <div class="entry-top"><h2>${circleIcon} ${entry.timestamp}</h2></div>
        <h3><span>${entry.avg} </span><span style="color: grey;"> AVG</span></h3>
        <h3><span>${entry.max} </span><span style="color: grey;"> MAX</span></h3>
